...
from transformer.functional import clones, attention
...
class ViT(nn.Module):
    def __init__(self, in_size, num_obs, out_size, dim, depth, heads, mlp_dim, pool = 'cls', dim_head = 64, dropout = 0., emb_dropout = 0.):
        super().__init__()
