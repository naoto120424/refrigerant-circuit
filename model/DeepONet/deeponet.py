...
class DeepONet(StructureNN):
    ...
    Output: [batch size, 1]
    '''
    def __init__(self, branch_dim, trunk_dim, pred_dim, num_all_features, branch_depth=2, trunk_depth=3, width=50,
    ...
    def forward(self, x, spec, gt):
        x_branch, x_trunk = x, gt  # x[..., :self.branch_dim], x[..., self.branch_dim:]
