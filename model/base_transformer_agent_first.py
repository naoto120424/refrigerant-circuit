...
class BaseTransformer(nn.Module):
    def __init__(self, look_back, dim=512, depth=3, heads=8, fc_dim=2048, dim_head=64, dropout=0.1, emb_dropout=0.1):
        ...
        self.pos_embedding = nn.Parameter(torch.randn(1, self.num_pred_features + self.num_all_features + self.num_control_features, dim))
    ...
    def forward(self, input, spec):
        ...
        # print('add pred token x', x.shape)
